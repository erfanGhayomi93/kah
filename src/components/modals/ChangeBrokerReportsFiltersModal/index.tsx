...
const ChangeBrokerReportsFiltersModal = forwardRef<HTMLDivElement, ChangeBrokerReportsFiltersModalProps>((props, ref) => {
	const t = useTranslations();

	const dispatch = useAppDispatch();

	const initialModalFilters = useAppSelector(getChangeBrokerReportsFiltersModal) as Partial<IChangeBrokerReportsFiltersModal>;

	const [filters, setFilters] = useState<Omit<ChangeBrokerReports.IChangeBrokerReportsFilters, 'pageNumber' | 'pageSize'>>({
