import { initialFreezeUnFreezeReportsFilters, initialTransactionsFilters } from '@/constants';
import { useAppDispatch, useAppSelector } from '@/features/hooks';
import { getFreezeUnFreezeReportsFiltersModal, setFreezeUnFreezeReportsFiltersModal } from '@/features/slices/modalSlice';
...
const FreezeUnFreezeReportsFiltersModal = forwardRef<HTMLDivElement, FreezeUnFreezeReportsFiltersModalProps>((props, ref) => {
	const t = useTranslations();

	const dispatch = useAppDispatch();

	const initialModalFilters = useAppSelector(getFreezeUnFreezeReportsFiltersModal) as Partial<IFreezeUnFreezeReportsFiltersModal>;

	const [filters, setFilters] = useState<Omit<FreezeUnFreezeReports.IFreezeUnFreezeReportsFilters, 'pageNumber' | 'pageSize'>>({
