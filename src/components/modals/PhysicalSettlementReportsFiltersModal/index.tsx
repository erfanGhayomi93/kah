import { initialCashSettlementReportsFilters, initialPhysicalSettlementReportsFilters } from '@/constants/filters';
import { useAppDispatch, useAppSelector } from '@/features/hooks';
import {
	getPhysicalSettlementReportsFiltersModal,
...
const PhysicalSettlementReportsFiltersModal = forwardRef<HTMLDivElement, PhysicalSettlementReportsFiltersModalProps>(
	(props, ref) => {
		...
		const initialModalFilters = useAppSelector(
			getPhysicalSettlementReportsFiltersModal,
		) as Partial<IPhysicalSettlementReportsFilters>;

		const [filters, setFilters] = useState<
			Omit<PhysicalSettlementReports.IPhysicalSettlementReportsFilters, 'pageNumber' | 'pageSize'>
		>({
