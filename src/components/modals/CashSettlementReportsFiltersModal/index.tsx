...
import { getCashSettlementReportsFiltersModal, setCashSettlementReportsFiltersModal } from '@/features/slices/modalSlice';
...
const CashSettlementReportsFiltersModal = forwardRef<HTMLDivElement, CashSettlementReportsFiltersModalProps>((props, ref) => {
	const t = useTranslations();

	const dispatch = useAppDispatch();

	const initialModalFilters = useAppSelector(getCashSettlementReportsFiltersModal) as Partial<ICashSettlementReportsFilters>;

	const [filters, setFilters] = useState<Omit<CashSettlementReports.ICashSettlementReportsFilters, 'pageNumber' | 'pageSize'>>({
