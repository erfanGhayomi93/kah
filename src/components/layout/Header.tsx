			...
			<div className='flex-1 flex-justify-end'>
				<Tooltip placement='bottom' content={t('header.black_scholes')}>
					<button
						...
						type='button'
						className='border-l border-l-gray-500 px-16 text-gray-900'
					>
						<svg
							width='2.4rem'
							height='2.4rem'
				...
				{isLoggedIn && (
					<button type='button' className='border-l border-l-gray-500 px-16 text-gray-900'>
						<BellSVG />
					</button>
				)}

				<div className='gap-16 pr-16 flex-items-center'>
					{isLoggedIn ? (
						<Popup
							margin={{
								y: 24,
										...
										<div className='gap-12 pt-16 flex-items-center fit-image'>
											...
											<div className='gap-4 flex-column'>
												<h3 className='text-base font-medium text-gray-1000'>
													{userInfo?.customerTitle ?? t('common.app_user')}
												</h3>
