			...
			className={clsx(
				...
				i === 0
					? [
							...
							id === 'LowRisk' &&
								'border-success-200 bg-success-200 text-gray-800 darkBlue:text-gray-50 dark:text-gray-50',
							id === 'ModerateRisk' &&
								'border-warning-100 bg-warning-100 text-gray-800 darkBlue:text-gray-50 dark:text-gray-50',
