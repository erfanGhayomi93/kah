...
const PlayAndPauseBtn = forwardRef<HTMLButtonElement, PlayAndPauseBtnProps>(
	({ className, isPaused, ...props }, ref) => (
		<button
			...
			className={
				className ??
				'relative h-40 flex-40 rounded border border-gray-200 text-gray-700 transition-colors flex-justify-center hover:border-primary-100 hover:bg-primary-100 hover:text-white'
			}
		>
