...
const Dropdown = ({
	...
	return (
		<div
			...
			className='relative flex-col overflow-auto rounded bg-white shadow-sm transition-height flex-justify-between darkBlue:bg-gray-50 dark:bg-gray-50'
		>
			...
			<div className='w-full bg-white p-16 flex-justify-end darkBlue:bg-gray-50 dark:bg-gray-50'>
