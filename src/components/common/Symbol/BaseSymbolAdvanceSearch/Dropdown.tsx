...
const Dropdown = ({
	...
	return (
		<div
			...
			className='relative flex-col overflow-auto rounded bg-white shadow-card transition-height flex-justify-between'
		>
			...
			<div className='w-full bg-white p-16 flex-justify-end'>
