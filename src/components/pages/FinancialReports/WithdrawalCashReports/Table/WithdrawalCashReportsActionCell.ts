...
type TWithdrawalCashReportsActionCellProps = ICellRendererParams<Reports.IWithdrawal, string> & {
	onDeleteRow?: (data: Reports.IWithdrawal | undefined) => Promise<void>;
	onEditRow?: (data: Reports.IWithdrawal | undefined) => void;
};

class WithdrawalCashReportsActionCell implements ICellRendererComp<Reports.IWithdrawal> {
	params!: TWithdrawalCashReportsActionCellProps;
	...
	init(params: TWithdrawalCashReportsActionCellProps) {
	...
	private createDeleteBtn(params: TWithdrawalCashReportsActionCellProps): HTMLButtonElement {
