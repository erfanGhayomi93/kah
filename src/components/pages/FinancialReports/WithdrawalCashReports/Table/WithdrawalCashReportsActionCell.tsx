...
type TWithdrawalCashReportsActionCellProps = ICellRendererParams<Reports.IDepositWithReceipt[], string> & {
...
class WithdrawalCashReportsActionCell implements ICellRendererComp<Reports.IDepositWithReceipt[]> {
	eGui!: HTMLDivElement;
