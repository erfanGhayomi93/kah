...
type TChangeBrokerReportsActionCellProps = ICellRendererParams<Reports.IChangeBrokerReports[], string> & {
	onDelete?: (data: Reports.IChangeBrokerReports[] | undefined) => Promise<void>;
};
...
class ChangeBrokerReportsActionCell implements ICellRendererComp<Reports.IChangeBrokerReports[]> {
	...
	init(params: TChangeBrokerReportsActionCellProps) {
	...
	refresh(params: TChangeBrokerReportsActionCellProps) {
		return true;
	}

	private createDeleteBtn(params: TChangeBrokerReportsActionCellProps): HTMLButtonElement {
