	...
	return (
		<div className='flex-justify-between'>
			...
			<div className='flex flex-grow-0 gap-8'>
				<button onClick={showOptionFilters} type='button' className='h-40 gap-8 rounded px-16 btn-primary-outline'>
				...
				<button type='button' className='h-40 w-44 rounded btn-primary-outline'>
