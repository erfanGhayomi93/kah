...
type TCashSettlementReportsTableActionCellProps = ICellRendererParams<Reports.ICashSettlementReports, string> & {
...
class CashSettlementReportsTableActionCell implements ICellRendererComp<Reports.ICashSettlementReports> {
	params!: TCashSettlementReportsTableActionCellProps;
	...
	init(params: TCashSettlementReportsTableActionCellProps) {
	...
	refresh(params: TCashSettlementReportsTableActionCellProps) {
		this.params = params;
		return true;
	}

	private createDeleteBtn(params: TCashSettlementReportsTableActionCellProps): HTMLButtonElement {
	...
	private createHistoryBtn(params: TCashSettlementReportsTableActionCellProps): HTMLButtonElement {
		const btn = document.createElement('button');
		btn.setAttribute('class', 'flex-justify-center text-gray-900 rounded px-4');
	...
	private createRequestBtn(params: TCashSettlementReportsTableActionCellProps): HTMLButtonElement {
		const btn = document.createElement('button');
		btn.setAttribute('class', 'flex-justify-center text-gray-900 rounded px-4');
		btn.disabled =
