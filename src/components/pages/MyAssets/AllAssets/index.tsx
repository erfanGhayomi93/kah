...
const AllAssets = () => {
	...
	return (
		<div className='flex-1 gap-8 rounded bg-white p-16 flex-column'>
			<div className='flex flex-wrap gap-8'>
				<Card
					style={{ flex: '1.24 1', minWidth: '20rem' }}
			...
			<div style={{ flex: '0 0 42.8rem' }} className='flex gap-8 flex-column *:rounded *:shadow-card xl:flex-row'>
				<div style={{ flex: '1.63 1' }} />
				<div style={{ flex: '1 1.63' }} />
			</div>
		</div>
	);
};

const Card = ({ title, value, icon, ...props }: CardProps) => (
	<div
		style={{ flex: '1 1.24', minWidth: '20rem' }}
		{...props}
		className='items-center gap-32 rounded py-32 text-center shadow-card flex-column'
	>
