...
class ActionColumn implements ICellRendererComp<Option.Root> {
	...
	init(params: ActionColumnProps) {
		...
		if (params?.addable) this.eGui.appendChild(this.createAddButton());
	}
